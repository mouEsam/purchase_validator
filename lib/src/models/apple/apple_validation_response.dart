...
class AppleValidationResponse {
  ...
  factory AppleValidationResponse.fromJson(Map<String, dynamic> json) => _$AppleValidationResponseFromJson(json);
...
class LatestReceiptInfo extends Equatable implements BaseReceipt {
  ...
  @override
  int get originalPurchaseDateMS => _appleDateTime(originalPurchaseDateMs, originalPurchaseDate);

  @override
  int get amount => int.tryParse(quantity) ?? 1;

  @override
  int get cancellationDateMS => _appleDateTime(cancellationDateMs, cancellationDate);
  ...
  @override
  List<Object> get props => [cancellationDate,
    cancellationDateMs,
    cancellationDatePst,
    cancellationReason,
    expiresDate,
